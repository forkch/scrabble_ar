/* SensorFusionJME - SensorFusionJME Example
 * 
 * Example Chapter 4
...
public class SensorFusionJME extends SimpleApplication  implements AnimEventListener { 

	private static final String TAG = "SensorFusionJME";
	...
	public static void main(String[] args) {
		SensorFusionJME app = new SensorFusionJME();
		app.start();
	}
