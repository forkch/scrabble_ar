/* SuperimposeJMEActivity - SuperimposeJME Example
 * 
 * Example Chapter 4
 * accompanying the book
 * "Augmented Reality for Android Application Development", Packt Publishing, 2013.
 * 
 * Copyright s 2013 Jens Grubert, Raphael Grasset / Packt Publishing.
 */
...
public class SuperimposeJMEActivity extends AndroidHarness {
	...
	private final Camera.PreviewCallback mCameraCallback = new Camera.PreviewCallback() {
		public void onPreviewFrame(byte[] data, Camera c) {
			if (c != null && stopPreview == false) {
				...
				if ((com.ar4android.superimposeJME.SuperimposeJME) app != null) {
					((com.ar4android.superimposeJME.SuperimposeJME) app)
